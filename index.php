  ...
  <div class="modal fade youtube" id="meuyoutube">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
		...
		<div class="form-group">
            <input type="number" class="form-control" name="celular" placeholder="55">
        </div>     
        <div class="form-group">
            <select name="opcao">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-primary btn-lg btn-block">Entrar</button>
                ...
                <?php if($qrcode){?>
                <div align="center">
                    <img width="400" height="400" src="https://chart.googleapis.com/chart?chs=400x400&cht=qr&chl=https://wa.me/<?php echo $_POST["celular"]?>">
